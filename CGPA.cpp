...
int main() {
    ...
    case 1: {
        float gpa = calculateGPA();             // for more accutate result we need to used double instead of float
...
*/
// if the user did not want to leave until he select teh exit then we will change return 0 into return true



                             // method 2 with some improvements
